    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          '按「搜尋」後（選好兩端也會自動搜）會列出實時選擇：路線、開出、到達、車程、步行、轉車等候和八達通車費。排序同時看車程、轉車（含等候）、步行和車費：只快一兩分鐘的轉乘不會排在直達前面。同一路線合成一格。同一路線若有稍後實時班次，按「稍後班次」可改乘那一班。只顯示現正有實時的路線。點一程即鎖定該班車，自動更新時不會改成下一班。若趕不上，按「錯過了」。',
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          '按「搜尋」後（選好兩端也會自動搜）會列出實時選擇：路線、開出、到達、車程、步行、轉車等候和八達通車費。排序同時看車程、轉車（含等候）、步行和車費。同一路線合成一格。同一路線若有稍後實時班次，按「稍後班次」可改乘那一班。只顯示現正有實時的路線。沿途到達若為推算會標「估計」。',
