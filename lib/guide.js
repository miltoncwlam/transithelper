    ...
    sections: [
      {
        ...
        p: [
          ...
          '選好路線後，用上方「選擇上車站」或點地圖上的站號，即顯示該站實時到站。終點可留空，此時會跟車至路線最後一站。'
        ]
      },
      {
        h: '路線地圖',
        p: [
          '選好路線後，地圖會畫出運輸署公布的巴士走線。點地圖上的車站，或用上方選單，即顯示該站實時到站，不用在長名單裡找。找不到官方走線時會說明，不會編造路徑。'
        ]
      },
      {
        h: '轉乘助手',
        p: [
          ...
          '選好第一程班次後，會鎖定該班車並顯示實時開出和到達轉車站時間，不會改成下一班。選好轉乘後同樣只留意該班接駁。',
      ...
      },
      {
        h: '港鐵／輕鐵',
        p: [
          '選路綫、車站，可選此程終點。港鐵會顯示下班車、到達、車程及沿途各站。輕鐵只公布本站倒數、鐘面時間和月台，沒有沿途各站；終點若不是該班次總站，仍會列出本站全部輕鐵，不會編造到達時間。若列車以本站為終點，會說明沒有沿途各站。'
        ]
      },
      {
        h: '我的回家路線',
    ...
    sections: [
      {
        ...
        p: [
          ...
          'After a route, pick a boarding stop from the list at the top, or tap the numbered station on the map — that shows live arrivals for that stop. You may pick a destination on the same trip; leave it empty to follow to the last stop.'
        ]
      },
      {
        h: 'Route map',
        p: [
          'After you pick a service, the map draws the Transport Department official bus path. Tap a numbered stop, or use the stop selector above the map, to see live arrivals — you do not have to hunt a long list. If no official line exists, the app says so and does not invent a path.'
        ]
      },
      {
        h: 'Transfer Buddy',
        p: [
          ...
          'After you pick a first bus, the app locks onto that trip and shows its live boarding and transfer-stop times — it does not switch to the next bus. A chosen connection is tracked the same way.',
      ...
      },
      {
        h: 'MTR / Light Rail',
        p: [
          'Pick a line and station, optionally a destination. MTR shows next trains, arrival, travel time and stop times. Light Rail publishes this stop only (minutes, clock, platform); if the destination is not a published terminus, every live Light Rail here is still listed — destination arrival is not invented. A train that ends here is described as terminating.'
        ]
      },
      {
        h: 'My travel home',
  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        h: '到站、終點、各站時間',
        p: [
          '選路線後，用上方選單或點地圖站號選上車站。可再選此程終點；終點只會列出上車之後的站。終點可留空，此時會跟車至路線最後一站。',
      ...
      },
      {
        ...
        p: [
          ...
          '輕鐵只公布本站倒數、鐘面時間和月台，沒有沿途各站。終點若不是該班次總站，仍會列出本站全部輕鐵，不會編造到達時間。若列車以本站為終點，會說明沒有沿途各站。馬場等不是每日服務的站，沒有車時會誠實顯示沒有。'
        ]
      },
      {
        h: '我的回家路線（只在這部裝置）',
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          'After a route, pick a boarding stop from the selector or the map. You may pick a destination on the same trip; only later stops are offered. Leave destination empty to follow to the last stop.',
      ...
      },
      {
        ...
        p: [
          ...
          'Light Rail publishes this stop only (minutes, clock, platform). If the destination is not a published terminus, every live Light Rail at this stop is still listed — destination arrival is not invented. A train that ends here is described as terminating. Stations that do not run every day (for example Racecourse) show empty when there is no service.'
        ]
      },
      {
