  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        h: '車費',
        p: [
          '搜尋結果顯示全程車費。選了上車站後，會顯示由該站到終點（或路線尾站）的八達通分段。沿途各站旁會標示由上車點到該站的車費。沒有資料的分段不會猜測。實際金額以車費機為準。轉乘助手會在路線旁顯示八達通車費，並以車程、轉車、步行和車費一併排序。'
        ]
      },
      {
        h: '港鐵',
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        h: 'Fares',
        p: [
          'Search cards show the full fare. After you pick a boarding stop, the Octopus section fare from that stop is shown. Later stops list the fare from boarding. Missing fare cells are omitted. Confirm the amount on the bus reader. Transfer Buddy lists Octopus fares and ranks by time, transfer, walking and fare.'
        ]
      },
      {
        h: 'MTR',
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          '資料來自運輸署分段表。沒有該格就留空，不會猜測。實際以車費機為準。轉乘助手以車程、轉車、步行和車費一併排序，並顯示八達通車費。'
        ]
      },
      {
        h: '港鐵',
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          'Figures come from Transport Department section tables. A missing cell is omitted, never guessed. Confirm on the bus reader. Transfer Buddy ranks by time, transfer, walking and fare, and shows the Octopus fare.'
        ]
      },
      {
        h: 'MTR',
