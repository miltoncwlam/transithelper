  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        h: '路線地圖',
        p: [
          '選好路線後，地圖會畫出運輸署公布的巴士走線（與 hkbus.app 同一來源），不是站與站直線，也不用推估行車路徑。可在「路線地圖」練習場對照。找不到官方走線時會說明，不會編造路徑。'
        ]
      },
      {
        h: '轉乘助手',
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        h: 'Route map',
        p: [
          'After you pick a service, the map draws the Transport Department official bus path (the same CSDI feed hkbus.app uses) — not a straight line between stops, and not a guessed drive path. The Route map playground lets you compare. If no official line exists, the app says so and does not invent a path.'
        ]
      },
      {
        h: 'Transfer Buddy',
